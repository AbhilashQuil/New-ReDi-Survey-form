...
export async function fetchDynamicChoices(args) {
...
export async function persistAnswers(args) {
...
export async function computeNextTask(args) {
    ...
    switch (last) {
        ...
        case 'Q4':
            ...
            const secondarySkills = allSkills.filter((skill) => skill !== primarySkill && skill !== "No Skills");
...
export async function validateFormData(args) {
    const errors = [];
